...
function build_qt {
    ...
    sed -i -e "s/from autocomplete import AutoComplete/from ..autocomplete import AutoComplete/g" $UI_PYTHON_PATH/$3.py
}
...
build_ui dialog
build_ui task_entity_widget
build_ui task_list_widget
build_ui task_regex_widget
build_ui task_shotgrid_entity_widget
